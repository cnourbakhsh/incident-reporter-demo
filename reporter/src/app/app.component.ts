...
export class MyApp implements OnDestroy {
  ...
  constructor(platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, private http: Http, private alertCtrl: AlertController) {
    ...
    this.notificationsSubcription = Observable.interval(3000).flatMap(i => this.http.get(environment.mobileBackendUrl + '/api/v1/notifications/reporter')).subscribe(res => {
